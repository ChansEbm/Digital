...
public class ContentDisplaceDrawerToggle implements DrawerToggle {
    ...
    public ContentDisplaceDrawerToggle(Activity a, DrawerLayout d, int containerResId, int
            gravity) {
        mActivity = a;
    ...
    public ContentDisplaceDrawerToggle(Activity a, DrawerLayout d, View containerView, int
            gravity) {
        mActivity = a;
        mContentView = getContentView();
        mDrawerLayout = d;
