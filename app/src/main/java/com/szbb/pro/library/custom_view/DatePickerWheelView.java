package com.szbb.pro.library.custom_view;
...
import com.szbb.pro.library.adapters.WheelTextAdapter;
import com.szbb.pro.library.dialog.WheelViewDialog;
import com.szbb.pro.library.util.DateUtil;
import com.szbb.pro.library.util.DensityUtil;
import com.szbb.pro.library.views.OnWheelChangedListener;
import com.szbb.pro.library.views.OnWheelScrollListener;
import com.szbb.pro.library.views.WheelView;
...
public class DatePickerWheelView extends LinearLayout implements OnWheelChangedListener, OnWheelScrollListener {
    ...
    private void init() {
        ...
        if (mode == WheelViewDialog.DATE) {
            LayoutParams wheelViewLayoutParams = new LayoutParams(DensityUtil.dp2px(context, (viewWidth - 50) / 3),
            ...
            LayoutParams wheelViewLayoutParams = new LayoutParams(DensityUtil.dp2px(context, viewWidth / 8 * 2),
                    LayoutParams.MATCH_PARENT);
            LayoutParams wheelViewLayoutParams2 = new LayoutParams(DensityUtil.dp2px(context, viewWidth / 8),
                    LayoutParams.MATCH_PARENT);
            wv_first.setLayoutParams(wheelViewLayoutParams);
