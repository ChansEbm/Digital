...
import com.szbb.pro.library.custom_view.DatePickerWheelView;
import com.szbb.pro.library.custom_view.LevelLinkageWheelView;
import com.szbb.pro.library.custom_view.NoLevelLinkageWheelView;
import com.szbb.pro.library.model.AreaBean;
import com.szbb.pro.library.util.DensityUtil;
        ...
        if (v.getId() == R.id.tv_confirm) {
            if (onPositiveButtonClickListener != null) {
                if (mode == DATE || mode == DATE_TIME) {
                    ...
                    onPositiveButtonClickListener.onTextSet(this, levelLinkageWheelView.getCurrentTextStr(), levelLinkageWheelView.getCurrentPos());
                } else if (mode == ONE_LEVEL || mode == TWO_LEVEL
                        || mode == THREE_LEVEL || mode == FOUR_LEVEL
                        || mode == FIVE_LEVEL) {
                    OnTextSetListener onPositiveButtonClickListener = (OnTextSetListener) this.onPositiveButtonClickListener;
                    onPositiveButtonClickListener.onTextSet(this, noLevelLinkageWheelView.getCurrentTextStr(), noLevelLinkageWheelView.getCurrentPos());
                }
            } else {
                dismiss();
            }
            ...
            if (onNegativeButtonClickListener != null) {
                if (mode == DATE || mode == DATE_TIME) {
                    ...
                    onNegativeButtonClickListener.onTextSet(this, noLevelLinkageWheelView.getCurrentTextStr(), levelLinkageWheelView.getCurrentPos());
                } else if (mode == ONE_LEVEL || mode == TWO_LEVEL
                        || mode == THREE_LEVEL || mode == FOUR_LEVEL
                        || mode == FIVE_LEVEL) {
                    OnTextSetListener onNegativeButtonClickListener = (OnTextSetListener) this.onNegativeButtonClickListener;
...
//        super.setTitle(title);
     ...
     * 设置日期
     *
     * @param date 1.模式为Date 格式2015-11-11
