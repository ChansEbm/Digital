...
/**
 * Created by ChanZeeBm on 2015/10/31.
 */
public class FullyGridLayoutManager extends GridLayoutManager {
    ...
    public FullyGridLayoutManager(Context context, int spanCount, int orientation, boolean
            reverseLayout) {
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int
        ...
        for (int i = 0; i < count; i++) {
            measureScrapChild(recycler, i, View.MeasureSpec.makeMeasureSpec(i, View.MeasureSpec
