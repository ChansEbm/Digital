...
public class NetworkBiz<E> {
    ...
    public NetworkBiz (@NonNull Context context) {
    ...
    public void login (@NonNull String userName,
        ...
        params.put("password",
                   pwd);
        String versionCode = MiscUtils.getAppVersion(context);
        params.put("app_version", String.valueOf(versionCode));
        params.put("sys_version", String.valueOf(Build.VERSION.SDK_INT));
    ...
    public void performanceBondLists (NetworkParams networkParams) {
        clearAllParams();
        params.put("auth", getAuth());
        new OkHttpBuilder.POST(appCompatActivity).urlAPIMember("performanceBondLists")
                                                 .entityClass(PerformanceBondBean.class)
                                                 .params(params)
                                                 .enqueue(networkParams,
                                                          tOkHttpResponseListener);
    }
